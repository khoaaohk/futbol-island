// Live-app check for riso stories: opens Paths → 11v11 → "Story: Mental Toughness" at four viewports and asserts the player contract.
...
const title=arg('--title','Mental Toughness'),format=arg('--format','11v11'),out=arg('--out','/private/tmp/claude-501/-Users-khoado-Desktop-Warp-Claude-Projects/a94b3f51-4163-4951-814b-79d6d6d74e9a/scratchpad/riso/reset');
