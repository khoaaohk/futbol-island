// Live-app check for riso story pocket-radio: opens Paths → 7v7 → "Story: The Pocket Radio" at four viewports and asserts the player contract.
...
const title=arg('--title','The Pocket Radio'),format=arg('--format','7v7'),out=arg('--out','/private/tmp/claude-501/-Users-khoado-Desktop-Warp-Claude-Projects/a94b3f51-4163-4951-814b-79d6d6d74e9a/scratchpad/riso/pocket-radio');
