// Live-app check for riso stories: opens Paths → 11v11 → "Story: After the Final Whistle" at four viewports and asserts the player contract.
// Usage: node scripts/check-riso-films-browser.mjs [--title "Mental Toughness"] [--format 11v11] [--out dir]
...
const title=arg('--title','After the Final Whistle'),format=arg('--format','11v11'),out=arg('--out','/private/tmp/claude-501/-Users-khoado-Desktop-Warp-Claude-Projects/a94b3f51-4163-4951-814b-79d6d6d74e9a/scratchpad/riso/loss');
