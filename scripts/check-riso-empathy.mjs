// Live-app check for riso story empathy: opens Paths → 7v7 → "Story: Emotional Intelligence" at four viewports and asserts the player contract.
...
const title=arg('--title','Emotional Intelligence'),format=arg('--format','7v7'),out=arg('--out','/private/tmp/claude-501/-Users-khoado-Desktop-Warp-Claude-Projects/a94b3f51-4163-4951-814b-79d6d6d74e9a/scratchpad/riso/empathy');
