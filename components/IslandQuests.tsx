...
export default function IslandQuests({onDiscover,onExplore,exploration=false}:{onLearn:()=>void;onMap:()=>void;onStore?:()=>void;onDiscover:()=>void;onExplore?:()=>void;exploration?:boolean}){
 ...
 <div className={journey.arrivalCopy}><span className={journey.eyebrow}>YOUR ISLAND ADVENTURE</span><h3>Have fun.<br/>Explore your island.</h3><p>Find your game. Every play takes you somewhere new.</p></div>
