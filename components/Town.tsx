...
export default function Island() {
  ...
  useEffect(()=>{
    ...
    const player=createPlayer('you','home',true,true);scene.add(player.root);player.root.scale.setScalar(1.12);player.root.name='main-character';player.root.rotation.y=Math.atan2(16,33);const characterGlow=createCharacterGlow(player.root);
    ...
    const airBallFrom=new T.Vector3(),airBallTo=new T.Vector3();
